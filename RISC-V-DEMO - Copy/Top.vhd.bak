...
entity Top is
	port (
		...
		-- DEMO OUTPUTS
		TOPcounter : inout std_logic_vector(31 downto 0); 	--0x80000000
		TOPdisplay1 : inout std_logic_vector(31 downto 0);	--0x80000004
		TOPdisplay2 : inout std_logic_vector(31 downto 0);	--0x80000008
		TOPleds : inout std_logic_vector(31 downto 0) 		--0x8000000c
	);
end entity;
...
begin
	...
	-- ALL
	SIGoutputDMorREG <= TOPcounter when SIGaddrDM = x"80000000"
							  else TOPdisplay1 when SIGaddrDM = x"80000004"
							  else TOPdisplay2 when SIGaddrDM = x"80000008"
							  else TOPleds when SIGaddrDM = x"8000000C"
							  else SIGoutputDM;
	-- INSTANCES
	instPROC : Processor
	port map(
